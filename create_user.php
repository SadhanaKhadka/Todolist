...
<form method="post" action="create_user.php">
	...
	Email<input type="email" name="txtEmail" class="form-control" autocomplete="off">
	Password<input type="password" name="txtPassword" class="form-control">
	User Type<select name="ddlUserType" class="form-control">
		<option selected hidden disable>Choose User Type</option>
		<option value="1">Admin User</option>
		<option value="2">Normal User</option>
	</select>

	<input type="submit" name="btnsave" value="Create" class="btn btn-primary">
</form>
